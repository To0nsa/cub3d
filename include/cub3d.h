...
void  process_color_key(t_game* game, const char* trimmed, const char* key,
                        int* dest);
...
void load_sprite_animation(t_game* game, t_texture** frames, char** paths,
                           int frame_count);
void init_npc_animation(t_game* game, t_sprite* sprite);
void init_AStar(t_game* game, t_npc* npc);
...
void draw_sprite(t_game* game, t_player player, t_sprite* sprite,
                 double* z_buffer);
void draw_texture(t_game* game, t_texture* texture, t_dpoint texture_pos,
                  double* z_buffer);
