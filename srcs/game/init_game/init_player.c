...
static void init_splash_animation(t_game* game, t_player* player,
                                  t_sprite* sprite)
{
	static char* splash_frames[] = {SPLASH_1, SPLASH_2, SPLASH_3, SPLASH_4,
	                                SPLASH_5, SPLASH_6, SPLASH_7};

	player->sprite.size                = (t_point){WIN_W, WIN_H};
	player->sprite.splash_paths        = splash_frames;
	player->sprite.splash_frames_count = sizeof(splash_frames) / sizeof(char*);
