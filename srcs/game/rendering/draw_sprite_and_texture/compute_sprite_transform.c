...
/*   Updated: 2025/04/10 09:37:24 by nlouis           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 */
static inline double compute_determinant(t_player player)
{
 ...
 */
static inline double compute_inverse_determinant(double det)
{
	return (1.0 / det);
}
 ...
 */
static inline double compute_transform_x(t_player player, t_dpoint rel,
                                         double inv_det)
{
	return (inv_det *
	        (player.facing_dir.y * rel.x - player.facing_dir.x * rel.y));
}
 ...
 */
static inline double compute_transform_y(t_player player, t_dpoint rel,
                                         double inv_det)
{
	return (inv_det *
	        (-player.view_plane.y * rel.x + player.view_plane.x * rel.y));
}
 ...
 */
static inline bool is_sprite_in_front(double transform_y)
{
 ...
 *         false otherwise.
 */
bool compute_sprite_transform(t_sprite_draw* data, t_player player)
{
	t_dpoint rel;
	double   det;
	double   inv_det;
