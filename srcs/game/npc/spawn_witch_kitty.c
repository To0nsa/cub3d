...
void init_witch_kitty_dialogues(t_game* game, t_npc* npc)
{
	...
	allocate_dialogues(game, &npc->dialogue, witch_kitty_dialogues,
	                   npc->dialogue.phase_count);
}
...
{
	static char* idle_frames[]  = {WS0, WS1, WS2, WS3,  WS4,  WS5,  WS6,
	                               WS7, WS8, WS9, WS10, WS11, WS12, WS13};
	static char* move_frames[]  = {WK_WAWAY0, WK_WAWAY1, WK_WAWAY2, WK_WAWAY3,
	                               WK_WTOW0,  WK_WTOW1,  WK_WTOW2,  WK_WTOW3,
	                               WK_WLEFT0, WK_WLEFT1, WK_WLEFT2, WK_WLEFT3,
	                               WK_WRI0,   WK_WRI1,   WK_WRI2,   WK_WRI3};
	static char* speak_frames[] = {WK_C0, WK_C1, WK_C2, WK_C3, WK_C4,  WK_C5,
