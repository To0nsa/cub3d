...
/*   Updated: 2025/04/14 09:31:45 by nlouis           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void init_calico_kitty_dialogues(t_game* game, t_npc* npc)
{
	static char* calico_kitty_dialogues[][10] = {
	    {CKD_0_0, NULL},
	    {CKD_1_0, CKD_1_1, CKD_1_2, CKD_1_3, CKD_1_4, CKD_1_5, CKD_1_6, CKD_1_7,
	     CKD_1_8, NULL},
	...
	allocate_dialogues(game, &npc->dialogue, calico_kitty_dialogues,
	                   npc->dialogue.phase_count);
}
...
{
	static char* idle_frames[]  = {CK0, CK1, CK2, CK3,  CK4,  CK5, CK6,
	                               CK7, CK8, CK9, CK10, CK11, CK12};
	static char* move_frames[]  = {CK_WTOW0,  CK_WTOW1,  CK_WTOW2,  CK_WTOW3,
	                               CK_WAWAY0, CK_WAWAY1, CK_WAWAY2, CK_WAWAY3,
	                               CK_WLEFT0, CK_WLEFT1, CK_WLEFT2, CK_WLEFT3,
	                               CK_WRI0,   CK_WRI1,   CK_WRI2,   CK_WRI3};
	static char* speak_frames[] = {CK_C0, CK_C1, CK_C2, CK_C3, CK_C4,
	                               CK_C5, CK_C6, CK_C7, CK_C8, CK_C9};
 ...
 * - pathfinding (`init_AStar`, `generate_npc_waypoints`)
