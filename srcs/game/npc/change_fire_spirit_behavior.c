...
void init_fire_spirit_dialogues(t_game* game, t_npc* npc)
{
	static char* dialogues[][10] = {
	    ...
	    {"Oh thanks for cooling me down!",
	     ...
	     "I'm sorry for the mess...", "I'm a fire spirit, you see...",
	     "I can't help it when I get too hot...",
	     "I am going to look for a way out...",
	     "If I find one, I'll let you know!", NULL},
	    {"You found a way out!?", "Lead the way, I am right behind you!", NULL},
	    {NULL},
	    {NULL},
	    {NULL},
	    {NULL},
	...
	allocate_dialogues(game, &npc->dialogue, dialogues,
...
{
	static char* npc_frames[] = {FS_N0, FS_N1, FS_N2, FS_N3, FS_N4};

	npc->sprite.size               = (t_point){50, 50};
	npc->sprite.idle_paths         = npc_frames;
	npc->sprite.idle_frames_count  = sizeof(npc_frames) / sizeof(npc_frames[0]);
	npc->sprite.move_paths         = npc_frames;
	npc->sprite.move_frames_count  = sizeof(npc_frames) / sizeof(npc_frames[0]);
	npc->sprite.speak_paths        = npc_frames;
	npc->sprite.speak_frames_count = sizeof(npc_frames) / sizeof(npc_frames[0]);
}
