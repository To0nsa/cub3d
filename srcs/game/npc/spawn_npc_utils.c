...
void init_npc_animation(t_game* game, t_sprite* sprite)
{
	...
	set_frame_sizes(sprite->idle_frames, sprite->idle_frames_count,
	                sprite->size);
	set_frame_sizes(sprite->move_frames, sprite->move_frames_count,
	                sprite->size);
	set_frame_sizes(sprite->speak_frames, sprite->speak_frames_count,
	                sprite->size);
	if (sprite->hit_frames)
		set_frame_sizes(sprite->hit_frames, sprite->hit_frames_count,
		                sprite->size);
...
{
	game->npcs = x_realloc(game, game->npcs, game->npc_count * sizeof(t_npc*),
